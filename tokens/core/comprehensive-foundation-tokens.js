...
export const foundationTokens = {
    ...
    utils: {
        // Get spacing value
        getSpacing: (key) => foundationpacing[key],
        // Get breakpoint value
        getBreakpoint: (key) => foundationGrid.breakpoints[key],
        // Get container max-width
        getContainer: (key) => foundationGrid.containers[key],
        // Get z-index value
        getZIndex: (key) => foundationLayout.zIndex[key],
        ...
        getResponsiveGrid: (mobile, tablet, desktop) => ({
            display: 'grid',
...
//# sourceMappingURL=comprehensive-foundation-tokens.js.map