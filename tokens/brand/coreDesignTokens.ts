...
export const designUtils = {
  ...
  space: (size: keyof typeof coreTokens.spacing | string) => 
    coreTokens.spacing[size as keyof typeof coreTokens.spacing] || size,
  
  // Get color with opacity
  color: (colorKey: keyof typeof coreTokens.colors, opacity = 1) => {
