...
interface ColorDefinition {
  name: string;
  value: string;
  category: 'foundation' | 'accent' | 'heritage' | 'functional' | 'semantic';
}

// Core Quantum-Spatial Color Palette
// Extracted from variables.css
const QUANTUM_SPATIAL_COLORS: ColorDefinition[] = [
  // === FOUNDATION ===
...
const GLASS_MATERIALS: ColorDefinition[] = [
