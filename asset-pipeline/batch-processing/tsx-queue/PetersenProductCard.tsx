...
interface PetersenProductCardProps {
  product: PetersenProduct;
...
/**
 * Apple HIG Compliant Petersen Games Product Card
 ...
 */
export const PetersenProductCard: React.FC<PetersenProductCardProps> = ({
  product,
  onAddToCart,
  onQuickView,
  className,
...
export default PetersenProductCard;