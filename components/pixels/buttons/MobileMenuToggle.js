...
const MobileMenuToggle = ({ onClick }) => {
    return (_jsx(motion.button, { whileTap: { scale: 0.95 }, onClick: onClick, style: {
            position: 'fixed',
        ...
        }, children: _jsx("div", { style: { color: enhancedDesignTokens.colors.text }, children: _jsx("svg", { width: "20", height: "20", viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M3 6h18v2H3V6zm0 5h18v2H3v-2zm0 5h18v2H3v-2z" }) }) }) }));
};
export default MobileMenuToggle;
//# sourceMappingURL=MobileMenuToggle.js.map