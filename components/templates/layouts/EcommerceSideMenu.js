...
const DashboardIcon = ({ className }) => (_jsx("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M13 3v6h8V3h-8zM3 3v6h8V3H3zm10 8v6h8v-6h-8zM3 11v6h8v-6H3z" }) }));
const OrdersIcon = ({ className }) => (_jsxs("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: [_jsx("path", { d: "M9 14l-5-5 1.5-1.5L9 11l7-7L17.5 5.5 9 14z" }), _jsx("path", { d: "M20 12v6a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h9" })] }));
const ProductsIcon = ({ className }) => (_jsxs("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: [_jsx("path", { d: "M4 4h16v2H4V4zm0 4h16v12H4V8zm2 2v8h12v-8H6z" }), _jsx("path", { d: "M8 12h2v2H8v-2zm4 0h2v2h-2v-2z" })] }));
const CustomersIcon = ({ className }) => (_jsx("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" }) }));
...
const InventoryIcon = ({ className }) => (_jsxs("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: [_jsx("path", { d: "M5 4h14l-1 7H6L5 4zM5 4L4 2H2v2h2l3 7h9l3-7H5z" }), _jsx("circle", { cx: "9", cy: "20", r: "1" }), _jsx("circle", { cx: "20", cy: "20", r: "1" })] }));
const PromotionsIcon = ({ className }) => (_jsxs("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: [_jsx("path", { d: "M9.5 3A6.5 6.5 0 0116 9.5c0 1.61-.59 3.09-1.56 4.23l.27.27h.79l5 5-1.5 1.5-5-5v-.79l-.27-.27A6.516 6.516 0 019.5 16a6.5 6.5 0 010-13zm0 2C7 5 5 7 5 9.5S7 14 9.5 14 14 12 14 9.5 12 5 9.5 5z" }), _jsx("path", { d: "M12 10h-2.5l2.5-3.5L14.5 10H12z" })] }));
const SettingsIcon = ({ className }) => (_jsx("svg", { className: className, viewBox: "0 0 24 24", fill: "currentColor", children: _jsx("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" }) }));
...
const LiquidGlassMenuItem = ({ item, isActive = false, onClick, collapsed = false, isMobile = false }) => {
    ...
    return (_jsxs(motion.button, { onClick: handleClick, onMouseEnter: () => setIsHovered(true), onMouseLeave: () => setIsHovered(false), whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, transition: {
            ...
            transition: `all ${liquidGlassTokens.animation.duration.short} ${liquidGlassTokens.animation.easing.standard}`,
        }, role: "button", tabIndex: 0, "aria-label": item.label, children: [_jsx("div", { style: {
                    width: '20px',
                    height: '20px',
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    transition: `color ${liquidGlassTokens.animation.duration.short} ${liquidGlassTokens.animation.easing.standard}`,
                }, children: _jsx(item.icon, {}) }), _jsx(AnimatePresence, { children: !collapsed && (_jsxs(motion.div, { initial: { opacity: 0, x: -10 }, animate: { opacity: 1, x: 0 }, exit: { opacity: 0, x: -10 }, transition: { duration: 0.2 }, style: {
                        flex: 1,
                        display: 'flex',
                        alignItems: 'center',
                        justifyContent: 'space-between'
                                ...
                                : item.badge }))] })) }), isActive && (_jsx("div", { style: {
                    position: 'absolute',
                    left: 0,
                    top: '50%',
                    width: '3px',
...
const SectionHeader = ({ label, collapsed }) => (_jsx(AnimatePresence, { children: !collapsed && (_jsx(motion.div, { initial: { opacity: 0, y: -5 }, animate: { opacity: 1, y: 0 }, exit: { opacity: 0, y: -5 }, style: {
            fontSize: liquidGlassTokens.typography.caption1.size,
            fontWeight: '600',
...
const EcommerceSideMenu = ({ activeItem, onItemClick, collapsed = false, isMobile = false, className = '', }) => {
    ...
    return (_jsxs(motion.nav, { className: className, variants: containerVariants, animate: collapsed ? "collapsed" : "expanded", style: {
            ...
            WebkitBackdropFilter: `blur(${liquidGlassTokens.effects.backgroundBlur})`,
        }, role: "navigation", "aria-label": "Store Navigation", children: [_jsx(AnimatePresence, { children: !collapsed && (_jsxs(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, style: {
                        ...
                        marginBottom: liquidGlassTokens.spacing.small,
                                ...
                                margin: 0,
                            }, children: "Store Dashboard" }), _jsx("p", { style: {
                                color: liquidGlassTokens.colors.tertiaryLabel,
                            ...
                            }, children: "Commerce Management" })] })) }), _jsx("div", { style: {
                    padding: collapsed ? liquidGlassTokens.spacing.small : liquidGlassTokens.spacing.medium,
                    flex: 1,
                    overflow: 'auto',
                }, children: ecommerceMenuSections.map((section) => (_jsxs("div", { children: [section.label && section.items.length > 0 && (_jsx(SectionHeader, { label: section.label, collapsed: collapsed })), section.items.map((item) => (_jsx(LiquidGlassMenuItem, { item: item, isActive: activeItem === item.id, onClick: onItemClick, collapsed: collapsed, isMobile: isMobile }, item.id)))] }, section.id))) })] }));
};
export default EcommerceSideMenu;
export { ecommerceMenuSections, liquidGlassTokens };
//# sourceMappingURL=EcommerceSideMenu.js.map