...
export const PetersenProductPageEnhancements = ({ product, className = '' }) => {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { jsx: true, global: true, children: `
      ...
      ` }), _jsx(QuickCheckoutModal, { isOpen: showQuickCheckout, onClose: () => setShowQuickCheckout(false), product: product, quantity: quantity, isMobile: typeof window !== 'undefined' ? window.innerWidth <= 768 : false })] }));
};
// Enhanced Homepage Integration Component
export const EnhancedHomepageIntegration = () => {
    return (_jsx("div", { className: "enhanced-homepage-wrapper", children: _jsx("style", { jsx: true, global: true, children: `
...
export const EnhancedFilterPageIntegration = () => {
    return (_jsx("div", { className: "enhanced-filter-page-wrapper", children: _jsx("style", { jsx: true, global: true, children: `
...
export const EnhancedProductPageActions = ({ product, onQuickBuy }) => {
    const [showCheckout, setShowCheckout] = useState(false);
    return (_jsxs("div", { className: "enhanced-product-actions", children: [_jsx("style", { jsx: true, children: `
        .enhanced-product-actions {
          display: flex;
          gap: ${unifiedDesignTokens.spacing.medium};
          margin-top: ${unifiedDesignTokens.spacing.large};
        }
      ` }), _jsx(EnhancedBuyNowButton, { product: product, onBuyNow: () => setShowCheckout(true), className: "flex-1" }), _jsx(motion.button, { whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, onClick: onQuickBuy, style: {
                    background: designUtils.getGlassCard('subtle').background,
                ...
                }, children: "\u2661 Wishlist" }), _jsx(CheckoutIntegration, { product: product, onClose: () => setShowCheckout(false) })] }));
};
