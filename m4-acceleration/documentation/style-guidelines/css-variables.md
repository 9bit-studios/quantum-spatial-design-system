...
Created: May 1, 2025 7:35 PM
Last Updated: May 1, 2025 7:35 PM
AI custom autofill: Resource Category: Design System
Doc Type: CSS Variables Documentation
Resource Type: Code Snippet
Overview: This section provides a comprehensive guide to CSS variables used in the 9Bit Studios Quantum-Spatial Design System, detailing foundational colors, spacing, typography, and animation.
Research Methods: Data Analysis, Pattern Recognition
...
:root {
  ...
  --font-secondary-display: 'SF Compact', sans-serif;
  --font-secondary-text: 'SF Compact', sans-serif;
