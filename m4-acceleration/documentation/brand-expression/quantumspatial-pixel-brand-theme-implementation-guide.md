...
- Create all textures at 2048×2048px master resolution with scaled variants
...
- Include master slides with varying grid densities for different content types
