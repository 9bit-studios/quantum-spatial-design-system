...
export default function QuantumSpatialfoundationystem(props) {
    ...
    const pixelDefinitions = [
        ...
        { name: "Dimensional Echo", state: "partial", primaryColor: "#126D71", accentColor: "#06D6A0", secondaryColor: "#131A36" },
        ...
        { name: "Quantum Core", state: "energy", primaryColor: "#5AC8FA", accentColor: "#06D6A0", secondaryColor: "#126D71" },
        { name: "Void Stream", state: "energy", primaryColor: "#6A3093", accentColor: "#BF4080", secondaryColor: "#FF2D55" },
        { name: "Ethereal Circuit", state: "energy", primaryColor: "#3DFF74", accentColor: "#06D6A0", secondaryColor: "#2C5F2D" },
        ...
        { name: "Reality Cascade", state: "superposition", primaryColor: "#FFFFFF", accentColor: "#06D6A0", secondaryColor: "#126D71" }
    ];
