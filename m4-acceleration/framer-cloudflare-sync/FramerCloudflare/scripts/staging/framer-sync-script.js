...
class FramerSync {
  constructor(config) {
    ...
    this.apiBaseUrl = 'https://api.framer.com/v1';
  }
  ...
  async uploadTokensToFramer(tokens, state) {
    ...
    try {
      const response = await fetch(
        `${this.apiBaseUrl}/teams/${this.teamId}/projects/${this.projectId}/variables`,
        {
          method: 'PUT',
          headers: {
  ...
  async getOrCreateComponentLibrary() {
    ...
    try {
      ...
      const response = await fetch(
        `${this.apiBaseUrl}/teams/${this.teamId}/component-libraries`,
        {
          method: 'GET',
          headers: {
            'Authorization': `Bearer ${this.apiKey}`
  ...
  async uploadComponentToFramer(libraryId, componentName, componentCode) {
    ...
    try {
      ...
      // Upload component
      const response = await fetch(
        `${this.apiBaseUrl}/teams/${this.teamId}/component-libraries/${libraryId}/components`,
        {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${this.apiKey}`
