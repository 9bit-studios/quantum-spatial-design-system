...
export default function PremiumQuantumSpatial(props) {
    ...
    // Premium color system - Onyx + Eggplant Dual Theme
    const premiumColors = {
        onyx: {
            bg: "#000000",           // Pure onyx black
            surface: "#0b010d",      // Eggplant void violet
            text: "rgba(255, 255, 255, 0.9)",
            accent: "#7b00ff",       // Vibrant purple (Dark mode)
            border: "rgba(255, 255, 255, 0.1)",
        },
        eggplant: {
            bg: "#160918",           // Eggplant deepnight
            surface: "#0b010d",      // Darker eggplant
            text: "rgba(255, 255, 255, 0.9)",
            accent: "#5ac8fa",       // Cyan
            border: "rgba(255, 255, 255, 0.1)",
        },
        heritage: {
            bg: "#0A0621",           // Void black
            surface: "rgba(44, 95, 45, 0.1)",
            text: "rgba(255, 255, 255, 0.9)",
            accent: "#2C5F2D",       // Heritage green
...
addPropertyControls(PremiumQuantumSpatial, {
    ...
    variant: {
        title: "Variant",
        type: ControlType.Enum,
        options: ["onyx", "eggplant", "heritage", "quantum"],
